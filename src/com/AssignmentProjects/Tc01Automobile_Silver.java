...
public class Tc01Automobile_Silver {
	...
	public static void main(String[] args) {
		...
		String exp_price = "233.00", act_price, 
		exp_onlineclaim = "No", act_onlineclaim;
	   // exp_claimdiscount = "No", act_claimdiscount,
		//exp_worldwidecover = "No", act_worldwidecover;
		
		act_price = driver.findElement(By.id("selectsilver_price")).getText();
		act_onlineclaim = driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[3]/td[2]")).getText();
	//	act_claimdiscount= driver.findElement(By.xpath())
		//act_worldwidecover= driver.findElement(By.xpath())
