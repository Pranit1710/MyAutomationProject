...
public class Tc10MotorCycle_Gold {
	...
	public static void main(String[] args) {
		...
		String exp_price = "1,075.00", act_price, 
	...
	//	exp_worldwidecover = "No", act_worldwidecover = null;
		...
		act_price = driver.findElement(By.id("selectgold_price")).getText();
		act_onlineclaim = driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[2]/td[3]")).getText();
		...
		act.moveToElement(driver.findElement(By.id("selectgold"))).click().perform();
