...
public class Tc12MotorCycle_Ultimate {
	...
	public static void main(String[] args) {
		...
		new Select(driver.findElement(By.xpath("//*[@id=\"make\"]"))).selectByIndex(2);
		new Select(driver.findElement(By.id("model"))).selectByIndex(4);
		driver.findElement(By.id("cylindercapacity")).sendKeys("121");
		driver.findElement(By.id("engineperformance")).sendKeys("999");
		driver.findElement(By.id("dateofmanufacture")).sendKeys("3/14/2023");
		new Select(driver.findElement(By.id("numberofseatsmotorcycle"))).selectByIndex(2);
		driver.findElement(By.id("listprice")).sendKeys("27000");
		...
		String exp_price = "4,021.00", act_price, 
		exp_onlineclaim = "Submit", act_onlineclaim;
	//	exp_claimdiscount = "No", act_claimdiscount = null, 
	//	exp_worldwidecover = "No", act_worldwidecover = null;
						
		act_price = driver.findElement(By.id("selectultimate_price")).getText();
		act_onlineclaim = driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[2]/td[5]")).getText();
		...
		act.moveToElement(driver.findElement(By.id("selectultimate"))).click().perform();
