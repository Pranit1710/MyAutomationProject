...
public class Tc16Camper_Ultimate {
	...
	//Vehical details
		...
		new Select(driver.findElement(By.xpath("//*[@id=\"make\"]"))).selectByIndex(4);
		driver.findElement(By.id("engineperformance")).sendKeys("1000");
		driver.findElement(By.id("dateofmanufacture")).sendKeys("10/10/2022");
		new Select(driver.findElement(By.id("numberofseats"))).selectByIndex(4);
		...
		driver.findElement(By.id("payload")).sendKeys("450");
		driver.findElement(By.id("totalweight")).sendKeys("15000");
		driver.findElement(By.id("listprice")).sendKeys("38000");
		driver.findElement(By.id("licenseplatenumber")).sendKeys("MH44AE8935");
	...
	// Select price Option
		...
		String exp_price = "3,330.00", act_price, 
